...
public class STAXFunctionActionFactory implements STAXActionFactory, STAXListRequestHandler, STAXQueryRequestHandler {
    public static final String STAX_FUNCTION_EVENT = "Function";
    static final String sFunctionListInfoMapClassName = "STAF/Service/STAX/FunctionListInfo";
    static final String sQueryFunctionMapClassName = "STAF/Service/STAX/QueryFunction";
    static final String sQueryFunctionImportMapClassName = "STAF/Service/STAX/QueryFunctionImport";
    ...
    public STAXFunctionActionFactory(STAX staxService) {
        ...
        fFunctionListInfoMapClass = new STAFMapClassDefinition(sFunctionListInfoMapClassName);
        ...
        fQueryFunctionMapClass = new STAFMapClassDefinition(sQueryFunctionMapClassName);
        ...
        fQueryFunctionImportMapClass = new STAFMapClassDefinition(sQueryFunctionImportMapClassName);
    ...
    public STAFResult handleListRequest(String type, STAXJob job, STAXRequestSettings settings) {
        if (type.equalsIgnoreCase("functions")) {
            ...
            for (STAXFunctionAction function : job.getSTAXDocument().getSortedFunctionMap().values()) {
                Map<String, Object> functionMap = new TreeMap<String, Object>();
                functionMap.put("staf-map-class-name", fFunctionListInfoMapClass.name());
                functionMap.put("function", (String) function.getName());
    ...
    public STAFResult handleQueryRequest(String type, String key, STAXJob job, STAXRequestSettings settings) {
        if (type.equalsIgnoreCase("function")) {
            ...
            if (function == null) {
                return new STAFResult(STAFResult.DoesNotExist, "Function '" + key + "' does not exist.");
            }
