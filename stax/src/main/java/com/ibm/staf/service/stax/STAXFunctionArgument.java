...
public class STAXFunctionArgument {
    public STAXFunctionArgument() { /* Do Nothing */ }
    ...
    public STAXFunctionArgument(String name, int type, String value, String description) {
        fName = name;
        fType = type;
        fDefaultValue = value;
        fDescription = description;
    ...
    public void setPrivate(boolean argPrivate) {
        fPrivate = argPrivate;
    }
