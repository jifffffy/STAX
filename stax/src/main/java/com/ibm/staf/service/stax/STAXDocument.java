...
public class STAXDocument {
    private HashMap<String, STAXFunctionAction> fFunctionMap = new HashMap<String, STAXFunctionAction>();

    private String fStartFunction;
    private String fStartFuncArgs;

    private LinkedList<STAXAction> fDefaultActions = new LinkedList<STAXAction>();
