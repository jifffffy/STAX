...
public class STAXUtil {
     ...
     */
    public static String parseAndCompileForPython(String value, STAXActionDefaultImpl action) throws STAXPythonCompileException {
    ...
    public static String formatErrorMessage(STAXActionDefaultImpl action) {
        ...
        errMsg.append(action.getXmlFile())
                .append(", Machine: ")
                .append(action.getXmlMachine());

        errMsg.append("\nLine ")
                .append(action.getLineNumber(info.getElementName(), info.getElementIndex()))
                .append(": ");

        if ((info.getElementName() != null) && (info.getAttributeName() == null)) {
            errMsg.append("Error in element type \"")
                    .append(info.getElementName()).append("\".");
        } else if ((info.getElementName() != null) && (info.getAttributeName() != null)) {
            errMsg.append("Error in attribute \"")
                    .append(info.getAttributeName())
                    .append("\" associated with element type \"")
                    .append(info.getElementName()).append("\".");
        }
