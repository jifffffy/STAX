...
public class STAXTimerAction extends STAXActionDefaultImpl implements STAXTimedEventListener {
    ...
    public STAXTimerAction() { /* Do Nothing */ }
            ...
            if (fState == INIT) {
                ...
                try {
                    ...
                    switch (fDurationString.charAt(fDurationString.length() - 1)) {
                        ...
                        case 'w': {
                            multiplier = 7 * 24 * 3600000;
                            break;
                        }
                        case 'y': {
                            multiplier = 365 * 24 * 3600000;
                            break;
                        }
                        default:
                            break;
                    ...
                    setElementInfo(new STAXElementInfo(getElement(), "duration", msg));
