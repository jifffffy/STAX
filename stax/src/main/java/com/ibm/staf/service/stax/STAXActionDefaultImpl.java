...
public class STAXActionDefaultImpl implements STAXAction {
    ...
    public STAXAction cloneAction() {
        ...
        clone.fLineNumberMap = new HashMap<String, Vector<String>>(fLineNumberMap);
    ...
    public void setLineNumber(Node root) {
        ...
        setLineNumber(root.getNodeName(), STAXUtil.getLineNumberFromAttrs(attrs));
    }
    ...
    public void throwSignal(STAXThread thread, STAXElementInfo staxElementInfo, String msgVar, String signal, STAXPythonEvaluationException e) {
        setElementInfo(staxElementInfo);
        thread.setSignalMsgVar(msgVar, STAXUtil.formatErrorMessage(this), e);
    ...
    private HashMap<String, Vector<String>> fLineNumberMap = new HashMap<String, Vector<String>>();
}
